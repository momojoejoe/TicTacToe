...
public class PlayerXWins3IT {
	 ...
	 */
	@Test
	public void testPlayerXWins3() throws Exception {
		//Creates a new game
		selenium.open("/");
		...
		selenium.click("1,0");
		Thread.sleep(1000);
		// verifyEquals("O", selenium.getText("1,0"));
		selenium.click("0,1");
		Thread.sleep(1000);
		// verifyEquals("X", selenium.getText("0,1"));
		selenium.click("1,1");
		Thread.sleep(1000);
		...
		// verifyEquals("Winner is Player 1", selenium.getText("gameover"));
