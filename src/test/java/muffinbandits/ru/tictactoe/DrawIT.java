...
public class DrawIT {
	...
	public void testDraw() throws Exception {
		...
		selenium.click("0,0");
		Thread.sleep(1000);
		assertEquals("X", selenium.getText("0,0"));
		selenium.click("0,1");
		Thread.sleep(1000);
		...
		selenium.click("2,0");
		Thread.sleep(1000);
		assertEquals("O", selenium.getText("2,0"));
		selenium.click("1,2");
		Thread.sleep(1000);
		...
		selenium.click("2,1");
		Thread.sleep(1000);
		assertEquals("X", selenium.getText("2,1"));
		selenium.click("2,2");
		Thread.sleep(1000);
		assertEquals("O", selenium.getText("2,2"));
		selenium.click("0,2");
		Thread.sleep(1000);
		assertEquals("X", selenium.getText("0,2"));
		Thread.sleep(1000);
		assertEquals("DRAW!", selenium.getText("gameover"));
